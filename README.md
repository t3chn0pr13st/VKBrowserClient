...
- 🖼 Публикация записей на стене с фото, документами и видео (в т.ч. вертикальными «клипами»).
...
- «Клип» = вертикальное видео через `video.save`; отдельная публикация в ленту «Клипы» не реализована.
